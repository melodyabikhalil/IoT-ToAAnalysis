...
void loop()
{
  ...
  //100 packets for packet size = 17 bytes
  PS = 17;
  for(int i=0; i<100; ++i){
  ...
  //100 packets for PS = 34 bytes
  PS = 34;
 
  for(int i=0; i<100; ++i){
 
  uint8_t data[] = "Hi, from Soumaya!Hi, from Soumaya!";
  ...
  //100 packets for PS = 51 bytes
  PS = 51;
  for(int i=0; i<100; ++i){
 
  uint8_t data[] = "Hi, from Soumaya!Hi, from Soumaya!Hi, from Soumaya!";
  ...
  //100 packets for PS = 68 bytes
  PS = 68;
  for(int i=0; i<100; ++i){
 
  uint8_t data[] = "Hi, from Soumaya!Hi, from Soumaya!Hi, from Soumaya!Hi, from Soumaya!";
